...
{
    public class Type2QuestionUtil
    {
        internal void Solve(string statement, Dictionary<string, string> newGalaxyRomanConversion, Dictionary<string, string> newGalaxyItemConversion, TypeOfQuestion typeOfQuestion)
        {
            ...
            {
                typeOfQuestion.Solve(romanIntegerValue, statement, newGalaxyItemConversion);
            }
        }
    }
}
